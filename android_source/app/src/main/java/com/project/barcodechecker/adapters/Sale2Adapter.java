...
public class Sale2Adapter extends ArrayAdapter<Sale> {
    private int resourceID;
    private int lastPosition = -1;
    private Context context;
    private Product product;

    public Sale2Adapter(@NonNull Context context, @LayoutRes int resourceID, @NonNull List<Sale> list) {
    ...
    public View getView(int position, @Nullable View convertView, @NonNull ViewGroup parent) {
        ...
        Sale2Adapter.ViewHolder viewHolder;
        final View result;
        if (convertView == null) {
            viewHolder = new Sale2Adapter.ViewHolder();
            ...
            viewHolder = (Sale2Adapter.ViewHolder) convertView.getTag();
            result = convertView;
        }
